        ...
        <div className={styles.container}>
          <div className={styles.left}>
            ...
            <p className={styles.subText}>
              When markets swing and uncertainty rises, LenDenClub helps you
              earn regular interest through diversified lending without being
              tied to daily market noise.
            </p>
                ...
                <>
                  <div className={styles.cardHeader}>
                    ...
                    <p className={styles.cardSubtitle}>
                      Track your portfolio or create a new account to start
                      lending.
                    </p>
                  </div>
